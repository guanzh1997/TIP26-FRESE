...
# def _resnet_1(arch, block, layers, modality, progress, **kwargs):
#     print(layers)
#     model = ResNet(block, layers, modality, **kwargs)
#     # pretrained_dict = torch.load('/data/gzh/MMNAS/two_stage/logs/resnet50-11ad3fa6.pth')
#     # pretrained_dict['conv1.weight'] = pretrained_dict['conv1.weight'].mean(dim=1, keepdim=True)
#     # print(model.load_state_dict(pretrained_dict, strict=False))
#
#     pretrained_dict = torch.load('/data/gzh/MMNAS/two_stage/logs/a/best_model_epoch_63_acc_0.6035.pth')
#     print(model.load_state_dict(pretrained_dict, strict=False))
#     # for param in model.parameters():
#     #     param.requires_grad = False
#     return model
#
# def resnet50_1(modality, progress=True, **kwargs):
#     return _resnet_1('resnet50', Bottleneck, [3, 4, 6, 3], modality, progress, **kwargs)
#
#
#
#
# def _resnet_2(arch, block, layers, modality, progress, **kwargs):
#     print(layers)
#     model = ResNet(block, layers, modality, **kwargs)
#     # pretrained_dict = torch.load('/data/gzh/MMNAS/two_stage/logs/resnet50-11ad3fa6.pth')
#     # print(model.load_state_dict(pretrained_dict, strict=False))
#
#     pretrained_dict = torch.load('/data/gzh/MMNAS/two_stage/logs/v/best_model_epoch_253_acc_0.6599.pth')
#     print(model.load_state_dict(pretrained_dict, strict=False))
#     # for param in model.parameters():
#     #     param.requires_grad = False
#     return model
#
# def resnet50_2(modality, progress=True, **kwargs):
#     return _resnet_2('resnet50', Bottleneck, [3, 4, 6, 3], modality, progress, **kwargs)